...
if(isset($_POST['done'])){
  ...
  $q = " INSERT INTO $Depo (`BusId`, `BusNum`, `DND`, `Status`) VALUES ( '$BusId','$BusNum','$DND','$Status' ) ";
...
<body>
 ...
 <h1 class="text-white text-center">  Insert Bus Information </h1>
 </div><br>
 ...
 <label> BusId </label>
 <input type="text" name="BusId" class="form-control"> <br>
